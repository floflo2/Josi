...
public class BoardUtilityOracle {
	// mask constants
	 ...
	 */
	private static String getFieldString(int maskValue, BoardOracle board, boolean bw) {
		// background
	 ...
	 * @param board the current board
	 */
	public static void printBoard(BoardOracle board) {
		if (board == null) {
	 ...
	 * @param board
	 */
	public static void printBoardBW(BoardOracle board) {
		if (board == null) {
			throw new IllegalArgumentException("Cannot print board if board equals null!");
		}
		StringBuilder sb = new StringBuilder();
