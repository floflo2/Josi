...
public abstract class Temperatures {
	...
	protected static void print(final Object... objects) {
		final String msg = Arrays.stream(objects).map(Object::toString).collect(Collectors.joining(" "));
		System.out.println(msg);
	}

	private static List<Temperature> parseCsvFile(final File csvFile) {
		try {
	...
	private static Function<String, Temperature> lineToTemperature = (line) -> {
		try {
