...
@ActivateHiddenBefore("2022-12-15 17:00 Europe/Berlin")
@WhitelistPath(value = "../pgdp2223*w09h01**", type = PathType.GLOB) // for manual assessment and development
@WhitelistPath(value = "paths", level = PathActionLevel.DELETE)
@BlacklistPath("paths_vault")
